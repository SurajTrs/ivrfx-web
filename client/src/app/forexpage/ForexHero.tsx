            ...
            >
              ...
              <Reveal delay={0.15}>
                <p className="lead text-white-50 mb-4 pe-lg-4">
                  Access the world’s most traded currency pairs across majors, minors and exotics.
              ...
              <div className="d-flex flex-wrap gap-3 mt-4">
                ...
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
                  <span className="text-white fw-semibold me-1">70+</span> pairs
                </div>
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
          ...
          <div className="col-12 col-lg-5">
            <Reveal delay={0.2}>
              <img
                ...
                alt="Trading on forex illustration"
