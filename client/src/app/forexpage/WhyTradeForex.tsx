...
const bullets = [
  { icon: "bi-graph-up-arrow", title: "Competitive spreads", desc: "From 0.6 pips on popular FX pairs." },
  { icon: "bi-lightning-charge", title: "Fast execution", desc: "Built for speed and reliability." },
  { icon: "bi-clock-history", title: "24/5 market", desc: "Trade the global FX market around the clock." },
  { icon: "bi-arrows-move", title: "Go long or short", desc: "Trade rising and falling markets." },
  { icon: "bi-sliders2", title: "Flexible sizing", desc: "Choose lot sizes to match your strategy." },
  { icon: "bi-shield-lock", title: "Regulated broker", desc: "Safety and transparency at the core." },
];

const WhyTradeForex: React.FC = () => (
  <section className="py-5">
    <div className="container">
      <div className="text-center mb-4">
        <Reveal as="h3" className="h2 fw-bold mb-2 gradient-text" delay={0.05}>
          Why trade Forex CFDs with us
        </Reveal>
