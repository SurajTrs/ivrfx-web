...
export default function BondsMarketSnapshot() {
  return (
    <section className="py-6 mt-5 position-relative overflow-hidden" aria-label="Bonds market snapshot" style={{
        ...
        <div className="d-flex align-items-end justify-content-between mb-3">
          <Reveal>
            <div>
              ...
              <h2 className="h1 m-0">Popular Bond assets</h2>
            </div>
          </Reveal>
        </div>
        <div className="table-responsive rounded-4" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(155,81,224,0.35)", boxShadow: "0 10px 30px rgba(155,81,224,0.15)", backdropFilter: "blur(8px)" }}>
