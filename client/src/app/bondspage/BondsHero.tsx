          ...
          <div className="col-12 col-lg-7">
            ...
            >
              <Reveal delay={0.05}>
                ...
                >
                  Trade Bond CFDs with Tight Spreads
                </h1>
              </Reveal>
              <Reveal delay={0.15}>
                <p className="lead text-white-50 mb-4 pe-lg-4">
                  Gain direct exposure to interest-rate moves with government bond CFDs. Go long or short on key benchmarks like US 10Y/30Y, GER 10Y and UK Gilts.
                </p>
              </Reveal>
              ...
              <div className="d-flex flex-wrap gap-3 mt-4">
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
                  <span className="text-white fw-semibold me-1">US</span> 10Y & 30Y
                </div>
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
                  <span className="text-white fw-semibold me-1">GER</span> 10Y
                </div>
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
                  <span className="text-white fw-semibold me-1">UK</span> Gilt 10Y
                </div>
              </div>
            </div>
          </div>
          <div className="col-12 col-lg-5">
            <Reveal delay={0.2}>
              <img
                ...
                alt="Trading bonds illustration"
