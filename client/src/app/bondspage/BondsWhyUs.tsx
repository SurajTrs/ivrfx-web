...
export default function BondsWhyUs() {
  const items = [
    { icon: "bi-cash-coin", title: "Tight pricing", desc: "Competitive spreads across popular bonds and durations." },
    { icon: "bi-speedometer2", title: "Powerful platform", desc: "Advanced charting, fast execution, and intuitive UI." },
    { icon: "bi-headset", title: "24/5 support", desc: "Get help whenever markets are open; tutorials and FAQs included." },
  ];

  return (
    <section className="py-6 mt-5 position-relative overflow-hidden" aria-label="Why us Bonds" style={{
      background: "radial-gradient(1200px 400px at 0% -20%, rgba(155,81,224,0.12), transparent 60%)",
    }}>
      <div className="container position-relative">
        <div className="text-center mb-4 mb-lg-5">
          ...
          <Reveal delay={0.05}>
            <h2 className="display-6 fw-bold m-0">Tools and support built for traders</h2>
          </Reveal>
        </div>
