...
const MT4FAQTeaser: React.FC = () => {
  return (
    <section className="py-5 mb-5 bg-transparent" aria-label="MT4 FAQs">
        ...
        <Reveal>
          ...
          >
            ...
            <div>
              ...
              <p className="m-0 mt-2" style={{ color: "#6b7280" }}>Find answers to common questions about using MetaTrader 4 with IVRFX.</p>
            </div>
