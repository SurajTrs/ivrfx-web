        ...
        <div className="row align-items-center g-4 g-lg-5">
          <div className="col-12 col-lg-7">
            <div className="p-4 p-lg-5 rounded-4 border border-opacity-25"
              ...
              <Reveal delay={0.05}>
                <h1 className="display-5 fw-bold mb-3 gradient-text">CFD Asset List</h1>
              </Reveal>
              <Reveal delay={0.15}>
                <p className="lead text-white-50 mb-4 pe-lg-4">
                  You can trade a wide range of CFD instruments, in numerous asset classes, at IVRFX, the home of
                  online CFD trading. Trade with our easy-to-use, customisable platform and discover a world of opportunities.
                </p>
              </Reveal>
              <div className="d-flex flex-wrap gap-3">
                <Reveal as="a" href="#assets" className="btn btn-success px-4 hover-lift" delay={0.25}>Browse Assets</Reveal>
                <Reveal as="a" href="#tools" className="btn btn-outline-light px-4 hover-lift" delay={0.35}>Tools & Trading Info</Reveal>
              </div>
            </div>
          </div>
          <div className="col-12 col-lg-5">
            <Reveal delay={0.2}>
              <div className="tilt-card shine-sweep rounded-4 shadow-lg">
                <img src="/images/cfd-hero.jpg" alt="Assets preview" className="img-fluid rounded-4" />
              </div>
            </Reveal>
          </div>
