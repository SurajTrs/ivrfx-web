...
export default function FAQAboutPage() {
  const label = categories.find((c) => c.key === "about")?.label ?? "About Us";
  const all = useMemo(() => faqs.filter((f) => f.category === "about"), []);
      ...
      <section className="py-5">
        <div className="container">
          ...
          <div className="input-group mb-4" style={{ maxWidth: 520 }}>
            ...
            <input className="form-control border-start-0" placeholder="Search in About Us" value={query} onChange={(e)=>setQuery(e.target.value)} />
          </div>
