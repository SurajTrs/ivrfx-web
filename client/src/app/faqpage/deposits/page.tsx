...
export default function FAQDepositsPage() {
  const label = categories.find((c) => c.key === "deposits")?.label ?? "Deposits & Withdrawals";
  const all = useMemo(() => faqs.filter((f) => f.category === "deposits"), []);
