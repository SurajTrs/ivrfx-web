...
export default function FAQDataProtectionPage() {
  const label = categories.find((c) => c.key === "data")?.label ?? "Data Protection";
  const all = useMemo(() => faqs.filter((f) => f.category === "data"), []);
