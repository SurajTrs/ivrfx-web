...
const benefits = [
  {
    ...
    desc: "Trade energies, metals and softs to diversify risk.",
    stat: "3+",
    foot: "asset classes",
  },
  {
    title: "Tight spreads",
    desc: "Competitive pricing on popular commodities.",
    stat: "from",
    foot: "low spreads",
  },
  {
    title: "Powerful tools",
    desc: "Advanced charts, alerts and risk management.",
    stat: "Pro",
    foot: "toolkit",
  },
  {
...
export default function CommoditiesBenefits() {
  return (
        ...
        <div className="d-flex align-items-end justify-content-between mb-4">
          <Reveal>
            <div>
              ...
              <h2 className="h1 m-0">Why trade Commodities with us</h2>
            </div>
          </Reveal>
        </div>
