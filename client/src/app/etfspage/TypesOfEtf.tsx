...
export default function TypesOfEtf() {
  const rows = [
    {
      title: "Sector ETFs",
      desc:
        "Focused exposure to industries like Technology, Energy, or Healthcare, letting you express targeted views.",
    ...
    },
    {
      title: "Index ETFs",
      desc:
        "Track major benchmarks such as the FTSE 100, S&P 500, or NASDAQ—broad market coverage in one trade.",
      image: "/images/trading-illustration1.png",
      reverse: true,
    },
    {
      title: "Commodity ETFs",
      desc: "Gain exposure to assets like Gold or Oil via ETFs that mirror underlying commodity performance.",
      image: "/images/trading-illustration1.png",
      reverse: false,
    },
    {
      title: "Thematic ETFs",
      desc:
        "Express views on long-term themes such as Clean Energy, AI, or Lithium, diversified within a single position.",
      image: "/images/trading-illustration1.png",
      reverse: true,
    },
  ];
  ...
  return (
    <section
      ...
      aria-label="Types of ETF"
      style={{
        background:
          "radial-gradient(1200px 400px at 100% -20%, rgba(155, 81, 224, 0.10), transparent 60%)",
      }}
    >
                  ...
                  >
                    <div className="d-flex align-items-start gap-3">
                      <div
                        ...
                        style={{ width: 44, height: 44, background: "rgba(155,81,224,0.15)", color: "#b185ff" }}
                      >
