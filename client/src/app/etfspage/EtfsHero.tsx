          ...
          <div className="col-12 col-lg-7">
            ...
            >
              <Reveal delay={0.05}>
                ...
                >
                  Trade ETF CFDs with Tight Spreads
                </h1>
              </Reveal>
              <Reveal delay={0.15}>
                <p className="lead text-white-50 mb-4 pe-lg-4">
                  Gain diversified exposure across sectors, commodities, and indices with ETF CFDs. Go long or short with fast execution.
                </p>
              </Reveal>
              ...
              <div className="d-flex flex-wrap gap-3 mt-4">
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
                  <span className="text-white fw-semibold me-1">100+</span> ETFs
                </div>
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
                  <span className="text-white fw-semibold me-1">Global</span> markets
                </div>
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
