            ...
            <div className="p-4 p-lg-5 rounded-4 border border-opacity-25" style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0.02) 100%)", backdropFilter: "blur(8px)" }}>
              ...
              <Reveal delay={0.05}>
                <h1 className="display-5 fw-bold mb-3" style={{
                  ...
                  backgroundClip: "text",
                  color: "transparent",
                }}>Trade on MetaTrader 5 (MT5)</h1>
              </Reveal>
              <Reveal delay={0.15}>
                <p className="lead text-white-50 mb-4 pe-lg-4">Next‑generation platform with more timeframes, more order types, hedging/netting modes, Depth of Market, and integrated economic calendar—across desktop, web and mobile.</p>
              </Reveal>
              <div className="d-flex flex-wrap gap-3">
                <Reveal as="a" href="#highlights" className="btn btn-success px-4 hover-lift" delay={0.25}>Download MT5</Reveal>
                <Reveal as="a" href="#tools" className="btn btn-outline-light px-4 hover-lift" delay={0.35}>View features</Reveal>
              </div>
              <div className="d-flex flex-wrap gap-3 mt-4">
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50"><span className="text-white fw-semibold me-1">More</span> timeframes</div>
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50"><span className="text-white fw-semibold me-1">Depth of</span> Market</div>
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50"><span className="text-white fw-semibold me-1">Hedging/Netting</span> modes</div>
              </div>
            </div>
          </div>
          <div className="col-12 col-lg-5">
            <Reveal delay={0.2}>
              <img src="/images/trading-illustration1.png" alt="MetaTrader 5 interface" className="img-fluid rounded-4 shadow-lg hover-lift" />
            </Reveal>
          </div>
