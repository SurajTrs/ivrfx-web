...
const MT5Benefits: React.FC = () => {
  return (
    <section className="py-5 mb-5 bg-transparent" aria-label="Use MT5 with IVRFX">
          ...
          <div className="row g-4 align-items-stretch">
            <div className="col-12 col-lg-7">
              ...
              >
                ...
                >
                  Use MT5 to trade with IVRFX
                </h3>
                <p className="text-secondary m-0">
                  If you already have an IVRFX account, you are all set. Simply install MT5 and add a trading account via your desktop IVRFX platform.
                  For more information on how to add a MetaTrader 5 trading account please <a href="#connect-guide" className="text-decoration-underline" style={{ color: "#9b51e0" }}>click here</a>.
