      ...
      <div className="row g-4">
        <div className="col-12 col-lg-8">
          <div className="p-4 p-lg-5 rounded-4 bg-white shadow-sm h-100">
            <h2 className="h4 fw-bold mb-3">CySEC (EU)</h2>
            <p className="mb-4 text-muted">markets.com, operated by Safecap Investments Limited (“Safecap”) Regulated by CySEC under licence no. 092/08</p>
            <ul className="list-unstyled mb-0">
              <li className="mb-3 d-flex align-items-start"><i className="bi bi-shield-check text-primary me-2"></i> Client’s funds are kept in segregated bank accounts</li>
              <li className="mb-3 d-flex align-items-start"><i className="bi bi-piggy-bank text-primary me-2"></i> Investor Compensation up to EUR 20,000</li>
