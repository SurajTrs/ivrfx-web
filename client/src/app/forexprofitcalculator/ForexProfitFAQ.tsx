...
const FAQ_ITEMS: QA[] = [
  {
    q: "What is a Forex Profit Calculator?",
    a: "It estimates potential profit or loss for a planned FX trade using your pair, size, entry and exit, including spreads, swaps and any commissions.",
  },
  {
    q: "Do results include spread and swaps?",
    a: "Yes, spreads and optional overnight swaps are included in the estimate when you input them (or when live data is available).",
  },
  {
    q: "Are commissions charged?",
    a: "Many FX accounts are commission-free. If your account charges commissions, include them to get a more accurate P/L estimate.",
  },
  {
    q: "Is leverage required for profit calculation?",
    a: "No. Profit calculation depends on entry vs exit and size. Leverage impacts margin requirement, not P/L directly.",
  },
];

export default function ForexProfitFAQ() {
  return (
    <section className="bg-white">
      <div className="container py-5 py-md-6">
        <div className="text-center mb-4">
          <h2 className="section-title">Forex Profit Calculator: FAQs</h2>
          <p className="text-secondary mb-0">Quick answers about estimating profit and loss for Forex trades.</p>
        </div>
