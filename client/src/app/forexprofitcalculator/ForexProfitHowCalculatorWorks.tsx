...
export default function ForexProfitHowCalculatorWorks() {
  const steps = [
    { n: 1, title1: "Select a currency pair (e.g., EUR/USD)" },
    { n: 2, title1: "Enter position size (units or lots)" },
    { n: 3, title1: "Choose Buy or Sell and set entry/exit" },
    { n: 4, title1: "Include spread, swaps and commission if any" },
    { n: 5, title1: "Calculate to see hypothetical P/L" },
  ];
    ...
    <section className="bg-white" id="learn">
      <div className="container py-5 py-md-6">
        <div className="text-center mb-4">
          <h2 className="section-title">How does a Forex Profit Calculator work?</h2>
          <p className="text-secondary mb-0">Quick steps to estimate potential profit or loss for your Forex trades.</p>
        </div>
