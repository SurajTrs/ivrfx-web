...
const ForexProfitCalculatorHero: React.FC = () => {
  return (
    <section
      ...
      aria-label="Forex Profit Calculator"
    >
      ...
      <div className="container position-relative">
        <div className="row align-items-center g-4 g-lg-5">
            ...
            <div className="p-4 p-lg-5 rounded-4 border border-opacity-25" style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0.02) 100%)", backdropFilter: "blur(8px)" }}>
              ...
              <Reveal delay={0.05}>
                <h1 className="display-5 fw-bold mb-3" style={{
                  ...
                  backgroundClip: "text",
                  color: "transparent",
                }}>Calculate potential Forex P/L quickly</h1>
              </Reveal>
              <Reveal delay={0.15}>
                <p className="lead text-white-50 mb-4 pe-lg-4">Estimate profit and loss for your currency trades, including spreads, swaps and commissions.</p>
              </Reveal>
          ...
          <div className="col-12 col-lg-5">
            <Reveal delay={0.2}>
              <img src="/images/trading-illustration1.png" alt="Forex profit calculator" className="img-fluid rounded-4 shadow-lg hover-lift" />
            </Reveal>
          </div>
...
export default ForexProfitCalculatorHero;
