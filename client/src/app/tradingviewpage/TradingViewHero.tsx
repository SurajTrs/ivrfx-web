            ...
            <div className="p-4 p-lg-5 rounded-4 border border-opacity-25" style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0.02) 100%)", backdropFilter: "blur(8px)" }}>
              <Reveal>
                <div className="d-inline-flex align-items-center gap-2 px-3 py-2 rounded-pill small mb-3" style={{ background: "rgba(34,197,94,0.18)", color: "#86efac", border: "1px solid rgba(34,197,94,0.35)" }}>
                  ...
                  Powered by TradingView • Web Platform
                </div>
              </Reveal>
              <Reveal delay={0.05}>
                <h1 className="display-5 fw-bold mb-3" style={{
                  ...
                  backgroundClip: "text",
                  color: "transparent",
                }}>Trade smarter on our modern web platform</h1>
              </Reveal>
              <Reveal delay={0.15}>
                <p className="lead text-white-50 mb-4 pe-lg-4">
                  Experience lightning-fast execution, real-time market data, and advanced TradingView charting—all in your browser with no installs required.
                </p>
              </Reveal>
              <div className="d-flex flex-wrap gap-3">
                <Reveal as="a" href="#get-started" className="btn btn-success px-4 hover-lift d-flex align-items-center gap-2" delay={0.25}>
                  <ArrowDownTrayIcon className="h-5 w-5" />
                  Launch Web Platform
                </Reveal>
                <Reveal as="a" href="#how-it-works" className="btn btn-outline-light px-4 hover-lift" delay={0.35}>
                  See how it works
                </Reveal>
              </div>
              <div className="d-flex flex-wrap gap-3 mt-4">
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
                  <span className="text-white fw-semibold me-1">Real-time</span> market data
                </div>
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
                  <span className="text-white fw-semibold me-1">Advanced</span> TradingView charts
                </div>
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
                  <span className="text-white fw-semibold me-1">One‑click</span> execution
                </div>
              </div>
            </div>
          </div>
