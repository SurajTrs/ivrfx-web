...
export default function CommoditiesCostsAndCharges() {
  return (
    <section className="bg-white">
      <div className="container py-5 py-md-6">
        <div className="text-center mb-4">
          <h2 className="section-title1">Commodities costs and charges explained</h2>
          <p className="text-secondary mb-0">Understand the key fees and costs you may encounter when trading commodities.</p>
        </div>
...
const ITEMS: {title: string; icon: string; desc: string[]}[] = [
  {
    title: "Commission",
    icon: "bi bi-asterisk",
    desc: ["Most commodity CFDs are commission-free; costs are usually in the spread."],
  },
  {
    title: "Spread",
