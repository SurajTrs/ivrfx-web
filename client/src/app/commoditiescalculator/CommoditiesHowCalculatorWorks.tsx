...
export default function CommoditiesHowCalculatorWorks() {
  const steps = [
    { n: 1, title1: "Choose a commodity (e.g., WTI, Gold)" },
    { n: 2, title1: "Select your order size (contracts/units)" },
    { n: 3, title1: "Pick direction: Buy or Sell" },
    { n: 4, title1: "Set leverage and inputs, then Calculate" },
    { n: 5, title1: "Review margin, spread, swaps and P/L" },
  ];
    ...
    <section className="bg-white">
      <div className="container py-5 py-md-6">
        <div className="text-center mb-4">
          <h2 className="section-title">How does a commodities profit calculator work?</h2>
          <p className="text-secondary mb-0">Follow these steps to estimate value, margin and potential P/L for your commodities trades.</p>
        </div>
