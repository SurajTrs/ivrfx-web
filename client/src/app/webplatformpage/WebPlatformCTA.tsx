          ...
          <div className="p-5 rounded-4 border bg-white shadow-sm mb-5">
            <div className="d-flex flex-column flex-lg-row align-items-start align-items-lg-center justify-content-between gap-3">
              <div>
                ...
                <h2 className="h1 m-0">Open an account and trade on the Web Platform</h2>
                <p className="text-muted m-0 mt-2">Institutional‑grade tools, fast execution and thousands of markets.</p>
              </div>
