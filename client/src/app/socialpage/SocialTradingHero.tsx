            ...
            <div className="p-4 p-lg-5 rounded-4 border border-opacity-25" style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0.02) 100%)", backdropFilter: "blur(8px)" }}>
              ...
              <Reveal delay={0.05}>
                <h1 className="display-5 fw-bold mb-3" style={{
                  ...
                  backgroundClip: "text",
                  color: "transparent",
                }}>Follow trades from top traders with Social Trading</h1>
              </Reveal>
              <Reveal delay={0.15}>
                <p className="lead text-white-50 mb-4 pe-lg-4">
                  Discover and follow proven signal providers, replicate their strategies with transparent performance metrics, and learn by doing—while staying in full control of your risk.
                </p>
              </Reveal>
              ...
              <div className="d-flex flex-wrap gap-3 mt-4">
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
                  <span className="text-white fw-semibold me-1">Copy</span> strategies
                </div>
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
                  <span className="text-white fw-semibold me-1">Transparent</span> performance
                </div>
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
                  <span className="text-white fw-semibold me-1">Risk</span> controls
                </div>
              </div>
            </div>
          </div>
