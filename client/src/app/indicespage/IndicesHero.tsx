          ...
          <div className="col-12 col-lg-7">
            ...
            >
              <Reveal delay={0.05}>
                ...
                >
                  Trade Global Indices 24/5
                </h1>
              </Reveal>
              <Reveal delay={0.15}>
                <p className="lead text-white-50 mb-4 pe-lg-4">
                  Take a position on the world’s biggest stock markets with tight spreads,
                  fast execution, and professional tools.
                </p>
              </Reveal>
              ...
              <div className="d-flex flex-wrap gap-3 mt-4">
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
                  <span className="text-white fw-semibold me-1">1 pt</span> spreads from
                </div>
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
                  <span className="text-white fw-semibold me-1">20+</span> indices
                </div>
                <div className="px-3 py-2 rounded-3 bg-dark border border-opacity-25 small text-white-50">
          ...
          <div className="col-12 col-lg-5">
            <Reveal delay={0.2}>
              <img
                ...
                alt="Trading indices illustration"
