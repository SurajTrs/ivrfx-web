        ...
        <div className="row align-items-center g-4 g-lg-5">
          <div className="col-12 col-lg-6 order-2 order-lg-1">
            <div className="tc-showcase position-relative mx-auto">
              <img className="tc-card-img tc-img-main rounded-4" src="/images/placeholder-app.png" alt="Trading app preview" />
            </div>
          </div>
          ...
          <div className="col-12 col-lg-6 order-1 order-lg-2">
            <div className="text-center text-lg-start">
              ...
              <a href="/auth/signup" className="btn tc-cta-green rounded-pill px-4 py-2 fw-semibold">Start Now</a>
            </div>
          </div>
        </div>
      </div>
