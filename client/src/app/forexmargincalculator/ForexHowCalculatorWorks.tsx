...
export default function ForexHowCalculatorWorks() {
  const steps = [
    { n: 1, title1: "Pick a Forex pair (e.g., EUR/USD)" },
    { n: 2, title1: "Choose your order size (units or lots)" },
    { n: 3, title1: "Select Buy or Sell" },
    ...
    <section className="bg-white">
      <div className="container py-5 py-md-6">
        <div className="text-center mb-4">
          <h2 className="section-title">How does a Forex margin calculator work?</h2>
          <p className="text-secondary mb-0">Follow these quick steps to estimate margin, value and potential P/L for your Forex trades.</p>
        </div>
