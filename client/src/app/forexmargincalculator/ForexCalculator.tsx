      ...
      <div className="container py-4 py-md-5">
        <div className="alert alert-light border rounded-4 mb-4 calc-info animate-fade-in">
          <div className="d-flex align-items-start gap-3">
            ...
            <div>
              <div className="title text-dark">What is a Forex Margin Calculator?</div>
              <p className="mb-1 desc">Use this calculator to estimate position value, margin requirement, spread and potential P/L on Forex instruments before you trade.</p>
