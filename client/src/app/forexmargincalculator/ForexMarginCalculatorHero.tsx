...
const ForexMarginCalculatorHero: React.FC = () => {
  return (
    <section
      ...
      aria-label="Forex Margin Calculator"
    >
      ...
      <div className="container position-relative">
        <div className="row align-items-center g-4 g-lg-5">
            ...
            <div className="p-4 p-lg-5 rounded-4 border border-opacity-25" style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0.02) 100%)", backdropFilter: "blur(8px)" }}>
              ...
              <Reveal delay={0.05}>
                <h1 className="display-5 fw-bold mb-3" style={{
                  ...
                  backgroundClip: "text",
                  color: "transparent",
                }}>Estimate margin, value and P/L for Forex trades</h1>
              </Reveal>
              <Reveal delay={0.15}>
                <p className="lead text-white-50 mb-4 pe-lg-4">Calculate your position value, margin requirement and potential P/L before you trade.</p>
              </Reveal>
          ...
          <div className="col-12 col-lg-5">
            <Reveal delay={0.2}>
              <img src="/images/trading-illustration1.png" alt="Forex trading interface" className="img-fluid rounded-4 shadow-lg hover-lift" />
            </Reveal>
          </div>
...
export default ForexMarginCalculatorHero;
