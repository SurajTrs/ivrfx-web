...
const FAQ_ITEMS: QA[] = [
  {
    ...
    a: "It's a tool to estimate margin requirement, position value, spread, swaps and potential P/L for a planned Forex trade before you place it.",
  },
  {
    q: "How accurate are the results?",
    a: "Results are estimates based on your inputs and typical fees. Actual outcomes vary with live pricing, spreads and swap rates.",
  },
  {
    q: "Do I pay commissions on Forex?",
    a: "Most FX pairs are commission-free. Costs are typically embedded in the spread and overnight swaps if positions are held overnight.",
  },
  {
    q: "What is margin and leverage in Forex?",
    a: "Leverage lets you control larger positions with less capital. Margin is the capital required to open/maintain that leveraged position.",
  },
];
    ...
    <section className="bg-white">
      <div className="container py-5 py-md-6">
        <div className="text-center mb-4">
          <h2 className="section-title">Forex calculator: FAQs</h2>
