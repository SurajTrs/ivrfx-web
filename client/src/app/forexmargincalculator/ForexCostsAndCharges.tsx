...
export default function ForexCostsAndCharges() {
  return (
    <section className="bg-white">
      <div className="container py-5 py-md-6">
        <div className="text-center mb-4">
          <h2 className="section-title1">Forex costs and charges explained</h2>
          <p className="text-secondary mb-0">Understand the key fees and costs you may encounter when trading Forex.</p>
        </div>
...
const ITEMS: {title: string; icon: string; desc: string[]}[] = [
  {
    title: "Commission",
    icon: "bi bi-asterisk",
    desc: ["Most FX pairs are commission-free; costs are embedded in the spread."],
  },
  {
    title: "Spread",
    icon: "bi bi-bar-chart-line",
    desc: [
      "The spread is the difference between the Bid and Ask. It varies by pair and market conditions.",
    ],
  },
  {
    ...
    desc: [
      "If your account currency differs from the quote currency, a conversion fee may apply at exit.",
    ],
  },
  {
    ...
    desc: [
      "Swap (rollover) can be a debit or credit depending on the pair and direction when positions are held overnight.",
    ],
  },
  {
    ...
    desc: [
      "Leverage lets you control larger positions; margin is the capital required to open/maintain a position.",
    ],
  },
];
