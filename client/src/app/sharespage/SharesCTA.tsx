...
export default function SharesCTA() {
  return (
    <section className="py-6 position-relative" aria-label="Call to action">
      ...
      <div
        ...
        style={{
          ...
          height: 560,
          filter: "blur(140px)",
          background: "radial-gradient(50% 50% at 50% 50%, rgba(12,178,116,.14) 0%, rgba(0,0,0,0) 70%)",
          bottom: -180,
          right: -160,
          pointerEvents: "none",
        }}
          ...
          <div className="row align-items-center g-4">
            <div className="col-12 col-lg-8">
              <Reveal>
                ...
                <h3 className="display-6 m-0 text-dark fw-bold">Open an account and start trading shares today</h3>
