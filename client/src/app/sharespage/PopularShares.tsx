...
export default function PopularShares() {
  return (
    <section id="popular" className="py-6 position-relative" aria-label="Popular shares">
      {/* Ambient glow */}
      <div
        ...
        style={{
          ...
          height: 520,
          filter: "blur(120px)",
          background: "radial-gradient(50% 50% at 50% 50%, rgba(12, 178, 116, 0.12) 0%, rgba(0,0,0,0) 70%)",
          top: -160,
          left: -140,
          pointerEvents: "none",
        }}
