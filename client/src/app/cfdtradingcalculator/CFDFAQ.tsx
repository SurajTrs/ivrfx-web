...
const FAQ_ITEMS: QA[] = [
  {
    q: "What is a CFD trading calculator?",
    a: "It's a tool that helps you estimate potential profit/loss, margin, and fees for a planned CFD trade before you place it.",
  },
  {
    q: "How accurate are the results?",
    a: "The calculator provides estimates based on your inputs and typical fees. Actual results can vary due to live pricing, spreads, and swap rates.",
  },
  {
    q: "Do I pay commissions?",
    a: "Most instruments are commission-free. Costs are typically embedded in the spread and overnight swaps if you hold positions overnight.",
  },
  {
    q: "What is margin and leverage?",
    a: "Leverage lets you control a larger position with less capital. Margin is the funds required to open/maintain that position.",
  },
];
