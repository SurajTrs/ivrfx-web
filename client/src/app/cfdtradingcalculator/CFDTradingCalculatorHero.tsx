...
const CFDTradingCalculatorHero: React.FC = () => {
  return (
    <section
            ...
            <div className="p-4 p-lg-5 rounded-4 border border-opacity-25" style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0.02) 100%)", backdropFilter: "blur(8px)" }}>
              ...
              <Reveal delay={0.05}>
                <h1 className="display-5 fw-bold mb-3" style={{
                  ...
                  backgroundClip: "text",
                  color: "transparent",
                }}>A professional multi‑asset CFD trading calculator</h1>
              </Reveal>
              <Reveal delay={0.15}>
                    <p className="lead text-white-50 mb-4 pe-lg-4">Calculate your potential profit and loss before you trade.</p>
              </Reveal>
...
export default CFDTradingCalculatorHero;
