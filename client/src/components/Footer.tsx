...
export default function TrustFooter() {
  ...
  const linkMap: Record<string, Record<string, string>> = {
    ...
    Trading: {
      "Social Trading": "/social-tradings",
      "Web Platform": "/trading/web-platform",
      App: "/trading-app",
      TradingView: "/trading/trading-view",
      MT4: "/trading/mt4",
      MT5: "/trading/mt5",
    },
    Learn: {
      News: "/news/news",
      "Trading Basics": "/learn/trading-basics",
      Webinars: "/events/webinars",
    },
    About: {
      "Why us": "/about/why-ivrfx",
      "Global Offering": "/about/global-offering",
